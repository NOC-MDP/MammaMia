...
search_start_time = datetime(2019, 6, 1,tzinfo=timezone.utc)
search_end_time = datetime(2019, 6, 30,tzinfo=timezone.utc)
...
for entry_name, entry in catalog.items():
    ...
    if temporal_extent:
        ...
        if (spatial_extent and
                ...
                search_start_time >= start_datetime and search_end_time <= end_datetime):
