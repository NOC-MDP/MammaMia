...
def virtual_mooring(spec_file: str):
    """
...
def follow_waypoints(spec_file: str) -> "GliderMissionBuilder":
    """
    ...
    Returns: a GliderMission object
    ...
    # prepare the mission files for the waypoiny plan
    if mission_parameters["dive_depth"] > 1000:
        raise Exception("no glider model capable of greater than 1000 metre depths")
