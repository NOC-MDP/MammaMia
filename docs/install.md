...
``` bash
$ git clone https://github.com/NOC-MDP/MammaMia/releases/tag/0.5.0
```

The above command will clone the 0.5.0 release of MAMMA MIA.
...
!!! note
    You will need an C++ compiler available on the command line where you are installing MAMMA MIA to be able to install glidersim.
